package com.yinuo.job.service.impl;

import com.yinuo.common.annotation.CronTag;
import com.yinuo.common.service.impl.BaseService;
import com.yinuo.job.dao.JobMapper;
import com.yinuo.job.domain.Job;
import com.yinuo.job.service.JobService;
import com.yinuo.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.yinuo.job.task");
